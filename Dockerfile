...
RUN pacman -Syyu --noconfirm --noprogressbar --quiet \
    ...
    && pacman -S --noconfirm --noprogressbar --quiet base-devel iverilog verilator yosys-git nextpnr-git prjapicula openfpgaloader bluespec-git bluespec-contrib-git \
